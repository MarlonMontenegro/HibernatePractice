...
public class PruebaDeParametros {
    public static void main(String[] args) {
        ...
        List<Producto> resultadoApiCriteria = productoDao.consultarPorParametrosConAPICriteria("X", null, null);

        System.out.println(resultadoApiCriteria.get(0).getDescription());
